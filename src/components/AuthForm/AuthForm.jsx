import { VStack, Box, Input ,Image, Button, Flex,Text } from '@chakra-ui/react'
...
const AuthForm = () => {
  ...
  <Box border ={"1px solid gray"} borderRadius = {4} padding={5}>
    <VStack spacing={4}>
       ...
       {!isLogin ? ( <Input placeholder = 'Confirm Password' value={inputs.confirmPassword} onChange={(e) => setInputs({...inputs, confirmPassword:e.target.value})} fontSize={14} type='password' /> ) : null}
